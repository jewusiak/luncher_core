...
public class PlaceAdministrationController {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200",
      ...
      content = @Content(mediaType = "application/json",
          schema = @Schema(implementation = AdminFullPlaceResponse.class))),})
  @PostMapping("")
  public ResponseEntity<?> adminCreatePlace(@RequestBody @Valid AdminCreatePlaceRequest request,
      User user) {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200",
      ...
      content = @Content(mediaType = "application/json",
          schema = @Schema(implementation = PagedAdminBasicPlaceResponse.class))),})
  @GetMapping("/search")
  public ResponseEntity<Page<AdminBasicPlaceResponse>> adminSearchPlaces(
      @RequestParam(required = false) String query, @RequestParam(
      defaultValue = "20",
